...
/**
 * @brief Terminates the thread with ID tid and deletes it from all
 * relevant control structures.
 *
 * All the resources allocated by the library for this thread should be released.
 * If no thread with ID tid exists it is considered an error. Terminating
 * the main thread (tid == 0) will result in the termination of the entire
